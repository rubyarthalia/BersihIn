...
<body>
    ...
    @else
        @if (!$logged_in)
            {{-- header customer sebelum signup login / DONE --}}
            <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm py-3 fixed-top"
                ...
                <div class="container">
                    ...
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                        ...
                        aria-label="Toggle navigation" style="border: none; box-shadow: none; color: #014A3F;">
                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center">
                            ...
                            <li class="nav-item d-flex align-items-center mt-2 mt-lg-0">
                                <a href="{{ route('cart.show') }}"
                                    class="mx-lg-3 text-decoration-none position-relative">
                                    <span class="d-none d-lg-inline">
                                        <i class="fa-solid fa-cart-shopping"
                            ...
                            <li class="nav-item mt-2 mt-lg-0">
                                <a class="nav-link mx-lg-3" href="{{ route('biodata.show') }}"
                                    style="color:#014A3F; font-weight: 700; font-size: clamp(16px, 2vw, 20px);">Sherin</a>
                            </li>
                        </ul>
                    </div>
                </div>
